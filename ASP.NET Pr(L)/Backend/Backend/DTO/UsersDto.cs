...
namespace Backend.DTOs
{
    public class UsersDto
    {
        ...
        public UsersDto(string Name, string Email, string Password, DateTime Dob, string Role, string ContactNum, string Gender, string Address, string Pincode, string State, string District)
        {
            this.Name = Name;
            this.Email = Email;
