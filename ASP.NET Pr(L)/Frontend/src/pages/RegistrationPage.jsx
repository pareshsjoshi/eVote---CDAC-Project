...
const RegistrationPage = () => {
  ...
  const handleSubmit = (values) => {
    ...
    console.log('Form Data Submitted:', JSON.stringify(values));
                ...
                <Row>
                  <Col md={6}>
                    ...
                    <Form.Group className="mb-3">
                      ...
                      <Field name="contactnum" type="text" className="form-control" />
                      <ErrorMessage name="contactnum" component="div" className="text-danger" />
                    </Form.Group>
                  </Col>
